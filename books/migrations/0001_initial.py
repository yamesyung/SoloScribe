# Generated by Django 4.2.17 on 2025-10-28 17:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.TextField(blank=True, null=True)),
                ('author_text', models.CharField(blank=True, max_length=300, null=True)),
                ('quotes_url', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_lf', models.CharField(blank=True, max_length=200, null=True)),
                ('average_rating', models.FloatField(blank=True, null=True)),
                ('publisher', models.CharField(blank=True, max_length=200, null=True)),
                ('binding', models.CharField(blank=True, max_length=100, null=True)),
                ('number_of_pages', models.IntegerField(blank=True, null=True)),
                ('user_shelves', models.TextField(blank=True, null=True)),
                ('user_shelves_positions', models.TextField(blank=True, null=True)),
                ('spoiler', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quote_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotequotetags', to='books.quote')),
        ...
        migrations.AddField(
            model_name='quote',
            name='review',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotes', to='books.review'),
        ),
        migrations.CreateModel(
            name='BookLocation',
            fields=[
