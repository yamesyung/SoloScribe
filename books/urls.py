...
htmx_urlpatterns = [
    ...
    path("rating-update/<int:review_id>/<int:new_rating>", gallery_rating_update, name='rating_update'),
    ...
    path("gallery-tag-update/<int:review_id>/", gallery_tag_update, name='gallery_tag_update'),
    path("gallery-tag-sidebar-update/", gallery_tag_sidebar_update, name='gallery_tag_sidebar_update'),
    path("gallery_date_read_update/<int:review_id>/", gallery_date_read_update, name='gallery_date_read_update'),
    path("gallery-year-sidebar-update/", gallery_year_sidebar_update, name='gallery_year_sidebar_update'),
    path("gallery-shelf-update/<int:review_id>/", gallery_shelf_update, name='gallery_shelf_update'),
    path("gallery-shelf-sidebar-update/", gallery_shelf_sidebar_update, name='gallery_shelf_sidebar_update'),
    path("gallery-delete-review/<int:review_id>/", gallery_delete_review, name='delete_review'),
    path("gallery-add-review/<int:review_id>/", gallery_add_review, name='add_review'),
